...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#dataRows tr").first().css("display", "none");

            $(".navbar .navbar-inner .nav li").removeClass("active");
            $(".navbar .navbar-inner li#department").addClass("active");
        ...
        <div class="row-fluid">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    -->
                    <asp:TextBox id="searchText" runat="server" AutoPostBack="false" placeholder="search keyword..."  onkeyup="searchKeyword(this.value);" ></asp:TextBox>
