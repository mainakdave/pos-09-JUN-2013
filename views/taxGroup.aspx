                ...
                <table>
                    <tr>
                        ...
                        <td><asp:DropDownList ID="country" runat="server" 
                                onselectedindexchanged="country_SelectedIndexChanged"></asp:DropDownList></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input id="category" type="text" placeholder="Category" class="span2" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input id="line1" type="text" placeholder="Line" class="span2" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input id="amount" type="text" placeholder="Amount" class="span2" /></td>
                    </tr>

                    <tr>
                        <td><label>Percentage</label></td>
                        <td><input id="percentage" type="text" placeholder="Percentage" class="span2" /></td>
                    </tr>
